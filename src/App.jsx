...
const App = () => {
    ...
    useEffect(() => {
        ...
        const fetchPersons = async () => {
            try {
                const response = await fetch('https://teamalpinobackend.onrender.com/user') // Realiza una solicitud GET a la URL especificada
                if (!response.ok) {
    ...
    const addPerson = async (person) => {
        try {
            const response = await fetch('https://teamalpinobackend.onrender.com/user', {
                method: 'POST',
