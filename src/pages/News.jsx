const News = () => {
    ...
    return (
        <div className="mt-4">
            <section className="text-gray-400 bg-gray-900 body-font rounded-lg shadow-lg">
                <div className="container px-3 py-10 mx-auto">
                    <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
                        <h1 className="flex-grow sm:pr-16 text-2xl font-medium title-font text-white">Con el siguiente link te va redirigir a una página de deportes</h1>
                        <button 
                            onClick={handleClick} 
