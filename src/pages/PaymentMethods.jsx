...
const PaymentMethods = () => {
    return (
        <section className="flex-1 flex flex-col p-5 justify-center items-center min-h-screen bg-gray-900">
            ...
            <p className="text-xl font-bold text-center text-white m-6">Estos medios de pago se habilitan para pagos de la cancha</p>

            <div className="flex flex-wrap justify-center gap-6">
                <div className="flex flex-wrap -m-4">
                    {/* Nequi Payment Method */}
                    <div className="p-4 lg:w-1/2 md:w-full">
                        <div className="flex border-2 rounded-lg border-gray-500 bg-gray-600 p-4 sm:flex-row flex-col items-center justify-center">
                            ...
                            <div className="flex-grow text-center">
                                ...
                                <p className="text-white text-lg">Escanea el QR y envía tus pagos al número <br></br>320-341-2535.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 lg:w-1/2 md:w-full">
                        <div className="flex border-2 rounded-lg border-gray-500 bg-gray-600 p-4 sm:flex-row flex-col items-center justify-center">
                            ...
                            <div className="flex-grow text-center">
                                ...
                                <p className="text-white text-lg">Pagos habilitados para Daviplata al número <br></br>320-341-2535.</p>
                            </div>
                        </div>
                    </div>
                </div>
